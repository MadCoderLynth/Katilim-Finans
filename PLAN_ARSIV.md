# Plan Arşivi — Tamamlanmış Faz Promptları

Bu dosya **otomatik yüklenmez.** Tamamlanmış adımların özgün promptları
kayıt amacıyla burada duruyor: bir adımın neden öyle yapıldığını sormak
gerektiğinde bakılır, yeniden koşulmaz.

Güncel iş: `PROJE_PLANI.md`. Kurallar ve durum: `CLAUDE.md`.
Her adımın ölçüm raporu kendi dosyasında (`ROTA_KESFI_RAPORU.md`,
`BILDIRIM_GECMISI_RAPORU.md`, `PILOT_20_RAPORU.md`, `INDIRME_RAPORU.md`,
`TOPLAMA_RAPORU.md`, `OZET_RAPORU.md`, `DERINLIK_KESFI_RAPORU.md`,
`DUZELTME_RAPORU.md`, `ON_MUTABAKAT_20260810.md`,
`XKTUM_REFERANS_RAPORU.md`, `MUTABAKAT_2025-10.md`, `MUTABAKAT_2026-05.md`).
